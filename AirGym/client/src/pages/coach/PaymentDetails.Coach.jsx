import PaymentDetails from "../../components/coach/PaymentDetails.Coach";
  ...
  if (isProgress) {
    return (
      <div className="flex h-screen items-center justify-center">
        <PiSpinnerBold className="mr-1 h-14 w-14 animate-spin font-bold text-orange-400" />
      </div>
    );
  }
  return (
